...
const ShareButton = ({
  ...
  return (
    <div className={cn(`share-button-container${isOpen ? '-open' : '-closed'}-${direction}`)}>
      <button className={cn(`${isOpen ? 'close-button' : 'main-button'}`)} onClick={toggleOpen}>
        {isOpen ? <img src={closeIconImage}/> : <img src={startIconImage} alt="" />} 
      </button>
